# 개인정보처리방침 — UtilityTrack

최종 업데이트: 2026-04-19

UtilityTrack("본 앱")은 자취생·1인 가구의 월세·공과금 납부 관리를 위한 Android 앱입니다. 본 방침은 본 앱이 수집·이용·보관하는 정보와 사용자의 권리를 설명합니다.
...
위 정보는 모두 **사용자 기기 내부**(Android Room DB, SharedPreferences)에만 저장되며, UtilityTrack 서버 또는 제3자에게 전송되지 않습니다. UtilityTrack은 서버를 운영하지 않습니다.
...
- 앱 내 모든 데이터는 시스템 설정 → 앱 → UtilityTrack → 저장공간 비우기로 즉시 삭제 가능
...
# Privacy Policy — UtilityTrack (English)

Last updated: 2026-04-19

UtilityTrack ("the App") helps single-household users in Korea manage rent and utility bill payments on Android. This policy explains what data the App collects, how it is used, and your rights.
...
All of the above is stored **only on your device** (Android Room DB, SharedPreferences). UtilityTrack runs no server and transmits nothing off your device.
...
- Delete all local data via system Settings → Apps → UtilityTrack → Clear storage
